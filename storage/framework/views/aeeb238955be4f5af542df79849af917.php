...
<div class="max-w-5xl mx-auto py-10">
    ...
    <?php if($selectedStore): ?>
        <div class="mb-6 p-4 border border-gray-300 rounded bg-white shadow-sm">
            ...
            <p class="text-gray-700"><?php echo e($selectedStore->name); ?></p>
            <p class="text-gray-600"><?php echo e($selectedStore->address); ?></p>
            <small class="text-gray-500">Contact: <?php echo e($selectedStore->contact_number); ?></small>
        </div>
    <?php else: ?>
    ...
    <form id="storeForm" method="POST" action="<?php echo e(route('select.store')); ?>">
        <?php echo csrf_field(); ?>
    ...
    <div class="text-center mt-8">
        <a href="<?php echo e(route('select.service')); ?>"
...
<?php echo $__env->make('user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\CapStone\resources\views/select-store.blade.php ENDPATH**/ ?>