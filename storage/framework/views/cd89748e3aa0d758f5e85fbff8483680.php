...
<div class="max-w-md mx-auto py-10">
    ...
    <form method="POST" action="<?php echo e(route('admin.login.post')); ?>" class="bg-white shadow rounded-lg p-6 space-y-6">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\CapStone\resources\views/admin/admin-login.blade.php ENDPATH**/ ?>