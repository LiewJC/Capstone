    ...
    <nav class="mt-6 px-4 space-y-2 text-sm">
        <?php if(session()->has('admin_email')): ?>
            <div class="text-blue-100 px-4 py-2">
                ...
                <span class="text-white"><?php echo e(session('admin_email')); ?></span>
            </div>
        <?php endif; ?>
        ...
        <?php if(session('role') === 'superadmin'): ?>
            <a href="<?php echo e(route('admin.manage-admin')); ?>"
               class="block py-2 px-4 rounded nav-item flex items-center space-x-3 hover:bg-primary-500 transition">
        ...
        <a href="<?php echo e(route('admin.manage-store')); ?>"
           class="block py-2 px-4 rounded nav-item flex items-center space-x-3 hover:bg-primary-500 transition">
            <i data-feather="map-pin" class="w-4 h-4"></i>
            <span>Manage Stores</span>
        </a>

        <a href="<?php echo e(route('admin.manage-booking')); ?>"
           class="block py-2 px-4 rounded nav-item flex items-center space-x-3 hover:bg-primary-500 transition">
        ...
        <a href="<?php echo e(route('admin.manage-discount')); ?>"
           class="block py-2 px-4 rounded nav-item flex items-center space-x-3 hover:bg-primary-500 transition">
        ...
        <form action="<?php echo e(route('admin.logout')); ?>" method="POST" class="mt-4 px-4">
            <?php echo csrf_field(); ?>
            <button type="submit"
...
<?php /**PATH C:\xampp1\htdocs\CapStone\resources\views/admin/admin-nav.blade.php ENDPATH**/ ?>